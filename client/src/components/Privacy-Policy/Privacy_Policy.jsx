...
const PrivacyPolicy = () => {
    return (
        <>
            <h1 style={{ marginTop: '6rem' }}>Privacy Policy</h1>
            <h5><b>Last updated: March 7, 2021</b></h5>
            <hr></hr>
            <p>Muqo Inc. ("us", "we", or "our") operates the Mq Music mobile application
(the "Service").</p>
            <p>This page informs you of our policies regarding the collection, use and
disclosure of Personal Information when you use our Service.</p>
            <p>We will not use or share your information with anyone except as described
...
and Conditions.</p>
            ...
            you. Personally identifiable information ("Personal Information") may
...
mobile Internet browser you use and other statistics ("Log Data").</p>
            ...
            services or to assist us in analyzing how our Service is used. These third
            parties have access to your Personal Information only to perform these
            tasks on our behalf and are obligated not to disclose or use it for any other
purpose.</p>
            <u>Compliance With Laws</u>
            <hr></hr>
            <p>We will disclose your Personal Information where required to do so by law
...
security or integrity of our Service.</p>
            <u>Security</u>
            <hr>
            </hr>
...
absolute security.</p>
            ...
            <hr></hr>
            <p>Your information, including Personal Information, may be transferred to -
...
may differ than those from your jurisdiction.</p>
            <p>If you are located outside Canada and choose to provide information to us,
            please note that we transfer the information, including Personal
Information, to Canada and process it there</p>
...
privacy policies or practices of any third party sites or services.</p>
            ...
            us. If we become aware that we have collected Personal Information from a
            child under age 13
